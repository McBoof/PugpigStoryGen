...
choiceNouns = ["rat", "pigeon", "monkey", "swordfish", "dain", "Mountain", "river", "forest", "Car", "bike", "scooter", "Book", "magazine", "newspaper", "Dog", "cat", "bird", "Table", "chair", "lamp", "House", "apartment", "cottage", "Pen", "pencil", "marker", "Phone", "tablet", "laptop", "Pizza", "burger", "sandwich", "Tree", "flower", "bush"]
